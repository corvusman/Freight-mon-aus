...
export const VARIANT_META: { full: VariantMeta; [k: string]: VariantMeta } = {
  full: {
    title: 'Freight Monitor - Australia & Pacific Freight Risk',
    description: 'A live freight and logistics situation monitor for Australian and Pacific roads, ports, vessels, weather, hazards and operational risk exposure.',
    keywords: 'Australian freight, logistics risk, road disruptions, port congestion, freight insurance, supply chain monitoring, Pacific shipping, operational exposure',
    url: 'https://freight-monitor.pages.dev/dashboard',
    siteName: 'Freight Monitor',
    shortName: 'Freight Monitor',
    subject: 'Australian and Pacific Freight Risk Intelligence',
    classification: 'Freight Dashboard, Logistics Risk Monitor, Insurance Risk Intelligence',
    categories: ['business', 'productivity'],
    features: [
      'Australian freight disruption mapping',
      'Road, port and maritime exposure monitoring',
      'Explainable operational risk profiles',
      'Explicit live, delayed, historical and simulated provenance',
    ],
  },
  tech: {
